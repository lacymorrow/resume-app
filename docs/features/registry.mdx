...
| Block | Description |
|-------|-------------|
| `dashboard` | User dashboard with projects, teams, API keys, deployments |
| `onboarding` | Multi-step setup wizard |
| `github-connect` | GitHub OAuth, repo creation, collaborator management |
| `vercel-connect` | Vercel deploy integration |
| `payload-cms` | Full Payload CMS collections and admin panel |
| `rbac` | Role-based access control service |
| `ai` | SmolLM browser AI + cloud AI (OpenAI, Anthropic) |

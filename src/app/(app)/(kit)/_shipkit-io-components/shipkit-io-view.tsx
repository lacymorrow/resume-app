...
import { ProductShowcase } from "@/app/(app)/(kit)/_shipkit-io-components/product-showcase";
      ...
      <div className="flex flex-col gap-16 overflow-hidden">
          ...
          <div className="flex min-h-[calc(100vh-16rem)] flex-col items-center justify-center mt-header">
            <div className="relative mx-auto flex min-h-64 max-w-[80rem] flex-col items-center justify-center gap-4 px-6 text-center md:px-8">
              ...
              <BlurFade delay={0.3} duration={0.4}>
                <h1 className="max-w-4xl mx-auto text-balance py-6 text-5xl font-medium leading-none tracking-tighter sm:text-6xl md:text-7xl lg:text-8xl">
                  {headings[0]}
                </h1>
              </BlurFade>
        ...
        <Section className="relative">
          <BlurFade delay={0.2} inView>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">Built with tools you know</span>
            </div>
          </BlurFade>
        ...
        <Section>
          <BlurFade delay={0.2} inView>
            ...
            <SectionHeader>Production-ready from day one</SectionHeader>
            <SectionCopy>
              Clone the repo and you have a working app with all of this already wired together.
            </SectionCopy>
          </BlurFade>
          <BlurFade delay={0.3} inView>
            <SectionContent>
